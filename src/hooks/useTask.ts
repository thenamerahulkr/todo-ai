...
export const useTasks = () => {
  ...
  const updateTask = useCallback(async (taskId: string, updates: Partial<Task>) => {
    ...
    try {
      ...
      // Show success message for manual edits (not for completion toggles)
      if (updates.title || updates.description || updates.priority || updates.category || updates.dueDate !== undefined || updates.tags !== undefined) {
